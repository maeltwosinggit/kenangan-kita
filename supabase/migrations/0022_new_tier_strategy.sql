...
('Elite', 'Full coverage for weddings & grand celebrations', 17500, 'myr', 1000, 365, '["1000 photos limit", "1 year storage", "Digital Photobook", "Custom event cover", "All-access ZIP export"]', 'MY');
...
('Elite', 'Full coverage for weddings & grand celebrations', 4500, 'usd', 1000, 365, '["1000 photos limit", "1 year storage", "Digital Photobook", "Custom event cover", "All-access ZIP export"]', 'GLOBAL');
